...
- 优先保留旧项目中真正有价值的引擎能力
- 避免直接照搬旧项目的舆情 / 平台化外壳
- 默认围绕“小说角色、组织、关系、世界规则、变量、平行世界”做领域建模
- 默认先做后端能力，再逐步做前端交互
...
- 平行世界配置: [backend/app/services/parallel_world_config_generator.py](../backend/app/services/parallel_world_config_generator.py)
