...
【反面：禁止这样写】
- "mask_behavior": "戴着面具示人，喜怒不形于色"  ← 太抽象，无可执行细节
- "believes_wrongly": "对世界有错误认知"  ← 没有具体内容，等于没写
- "decision_pattern": "复杂多变"  ← 不可执行的废话

【正面：应该这样写】
- "mask_behavior": "在长辈面前永远保持温顺微笑，但右手会无意识攥紧衣角；遇到威胁时会先笑着退让一步，再寻找反击时机"
- "believes_wrongly": "误以为师父三年前的遇刺是仇家所为，实际上是同门设局；这个错认让他三年来都在错误方向追查"
- "decision_pattern": "面临重要抉择时倾向于先观察 24 小时再下决断；只要涉及亲人安危则会瞬间放弃所有理性计算，本能优先"

写所有字段时都遵循这个原则：用**具体的行为细节、特定情境、可观察的反应**替代抽象描述。
"""
