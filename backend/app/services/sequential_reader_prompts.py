  ...
  "character_updates": [
    {
      ...
      "quote_examples": ["原文对话或独白引用，15-40字"],
  ...
  "relationship_changes": [
    {
      "source": "主动方角色名",
      "target": "被动方角色名",
      "relation": "关系类型（盟友/对立/师徒/背叛/重逢/合作/其他）",
      "previous_state": "之前关系状态（若已知）",
      "trigger": "导致关系变化的事件",
      "evidence": "原文佐证，15-50字"
    }
  ],
  "plot_threads": [
    {
...
ARC_SUMMARY_SYSTEM_PROMPT = """你是一名小说分析师，需要将多段阅读摘要整合为一个弧线摘要。

你会收到：
1. 当前已知的故事核心设定（可选，可能为空）
2. 若干段落摘要（按顺序排列）

请将这些段落摘要整合为约 800 字的弧线摘要，聚焦于：
- 这一弧线的核心冲突和驱动力
- 主要角色在这一弧线中的成长或转变
- 弧线的开端、发展与结尾（或悬念）
- 对后续故事的铺垫
